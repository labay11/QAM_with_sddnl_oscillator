...
from memory import plot_time_only_n
...
def fig4b():
    ...
    plot_time_only_n(4, fig=fig, ax=axs['a'])

    handles, labels = axs['a'].get_legend_handles_labels()
    axs['a'].legend(handles, labels,
                    ncol=2, loc='lower left', bbox_to_anchor=(0.05, 0.06), title=r'$\dim \mathcal{H}_{eff}$')
