...
do
    ...
    do
        # run2 -t 05:00 -n "sq32" "python squeezing.py -n 3 -m 2 --bmin 0 --bmax 20 --bnum 500 -d $d -g $g"
        # run2 -t 05:00 -n "sq43" "python squeezing.py -n 4 -m 3 --bmin 0 --bmax 20 --bnum 500 -d $d -g $g"
        # run2 -t 05:00 -n "sq34" "python squeezing.py -n 3 -m 4 --bmin 0 --bmax 20 --bnum 500 -d $d -g $g"
...
# run2 -t 2:00 -n "sq33" "python squeezing.py -n 3 -m 3 --bmin 0 --bmax 20 --bnum 100"
# run2 -t 2:00 -n "sq44" "python squeezing.py -n 4 -m 4 --bmin 0 --bmax 20 --bnum 100"
